...
class Footer extends React.Component {
    ...
    render() {
        const socmedList = socialMedia.map(socmed => <a href={socmed.link} target="_blank" rel="noopener noreferrer" style={{ color: '#ffffff' }}> <FontAwesomeIcon icon={socmed.icon} /></a>)
