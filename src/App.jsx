...
// ambil icon yang diperlukan saja
...
// jangan lupa register icon yang udah diambil diatas, biar bisa dipake
...
export default function App() {
  return (
    <>
      {process.env.REACT_APP_APP_ENV !== 'production' ? <ExperimentalBanner /> : null}
      <Router>
        <Switch>
